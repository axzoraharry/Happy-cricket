        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="flex flex-col gap-2">
            <Link href="/" className="flex items-center gap-2">
              ...
              <span className="font-bold text-lg">Cricket Fantasy</span>
            </Link>
            <p className="text-sm text-muted-foreground">
              Create your dream cricket team, compete with friends, and win exciting prizes based on real-world cricket
              performances.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/points-system" className="text-muted-foreground hover:text-foreground">
                  Points System
                </Link>
              </li>
              <li>
